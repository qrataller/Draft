# -*- coding: utf-8 -*-
"""
Created on Sat May 18 14:00:25 2024
...
def load_model(model_path):
    ...
    print("Model summary:")
    print(model.summary())  # Print model summary to verify its architecture
    return model

st.write("""
# Dog Classification by
## Gonzales and Taller"""
)
file=st.file_uploader("Choose photo of a dog from your computer",type=["jpg","png"])
